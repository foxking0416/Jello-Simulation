...
public:
    ...
    enum IntegrationType { EULER, MIDPOINT, RK4 ,LEAPFROG};
    ...
    // Spring types
    enum SpringType { STRUCTURAL = 0x1, SHEAR = 0x2, BEND = 0x4 , ADD = 0x5 , ADD2 = 0x6}; 
	...
	void applyAddForce(vec3 f);
	vec3 additionalForce;
protected:
	...
	virtual void AddAdditionalSpring(Particle& p1, Particle& p2);
	virtual void AddAdditionalSpring2(Particle& p1, Particle& p2);
...
public:
 ...
 //   static double g_addKs;
 //   static double g_addKd;
	//static double epsilon;
	double g_structuralKs;
	double g_structuralKd;
	double g_shearKs;
	double g_shearKd;
	double g_bendKs;
	double g_bendKd;
	...
	double g_structuralKs_Mid;
	double g_structuralKd_Mid;
	double g_shearKs_Mid;
	double g_shearKd_Mid;
	double g_bendKs_Mid;
	double g_bendKd_Mid;
	double g_penaltyKs_Mid;
	double g_penaltyKd_Mid;
	double g_addKs_Mid;
	double g_addKd_Mid;
	double g_add2Ks_Mid;
	double g_add2Kd_Mid;

	double g_structuralKs_Euler;
	double g_structuralKd_Euler;
	double g_shearKs_Euler;
	double g_shearKd_Euler;
	double g_bendKs_Euler;
	double g_bendKd_Euler;
	double g_penaltyKs_Euler;
	double g_penaltyKd_Euler;
	double g_addKs_Euler;
	double g_addKd_Euler;	
	double g_add2Ks_Euler;
	double g_add2Kd_Euler;
